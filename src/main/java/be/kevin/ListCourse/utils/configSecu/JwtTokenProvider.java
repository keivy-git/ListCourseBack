...
public class JwtTokenProvider {
    ...
    @Value("${security.jwt.token.expire-length:3600000}") // 1 heure
    ...
    public String createToken(String name, List<String> role) {
   ...
   public Authentication getAuthentication(String token) {
       UserDetails userDetails = this.userService.loadUserByUsername(getName(token));
